...
|-----------|----------|----------|
| Architecture & design | Blinky | System design, patterns, technical decisions |
| Game mechanics | Inky | Game loop, collision, AI, input, state management |
| Graphics & UI | Pinky | Sprites, animations, rendering, visual effects, menus |
| Code review | Blinky | Review PRs, check quality, suggest improvements |
| Testing | Clyde | Write tests, find edge cases, verify fixes |
| Scope & priorities | Blinky | What to build next, trade-offs, decisions |
